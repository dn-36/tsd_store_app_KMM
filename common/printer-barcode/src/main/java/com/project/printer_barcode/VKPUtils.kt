...
fun textToBitmap(
 ...
 fun setSizeBitMap(originalBitmap: Bitmap, widthDp: Int, heightDp: Int, context: Context): Bitmap {
...
fun generateBarcode(content: String, heightMm: Int): Bitmap? {
    return try {
        ...
        val barcodeBitmap = barcodeEncoder.encodeBitmap(content, BarcodeFormat.CODE_128, widthPx, heightPx)
