...
class ScanerPointMobileScreen(
  private val nextStep:(String)->Unit,
  private val   viewModel: ScanerPointMobileViewModel = ScanerPointMobileViewModel(getKoin().get()) // или другой способ
): Screen {
                ...
                Column(verticalArrangement = Arrangement.Top) {
                    ...
                    Row {
                        Button(onClick = {
                            ...
                            nextStep(viewModel.uiState.value.scanResult)
