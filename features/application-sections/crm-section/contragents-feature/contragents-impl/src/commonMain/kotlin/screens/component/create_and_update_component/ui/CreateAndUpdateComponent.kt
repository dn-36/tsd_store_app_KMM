package screens.component.create_and_update_component.ui
...
import screens.component.create_and_update_component.viewmodel.CreateAndUpdateIntents
import screens.component.create_and_update_component.viewmodel.CreateAndUpdateViewModel
import screens.model.ContragentResponseModel
import screens.viewmodel.ContragentsIntents
...
class CreateAndUpdateComponent (
    ...
    val onClickCreate: ( name:String, scope: CoroutineScope ) -> Unit,

    val onClickUpdate: ( name:String, scope: CoroutineScope ) -> Unit,
                    ...
                    if ( index == 2 ) {
                        ...
                        Button(
                            onClick = {
                                      ...
                                      onClickCreate( vm.state.name, scope )
                        ...
                        Button(
                            onClick = { onClickUpdate( vm.state.name, scope ) },
                            modifier = Modifier
                                .padding(bottom = 10.dp)
                                .clip(RoundedCornerShape(70.dp))
                                .height(40.dp)
